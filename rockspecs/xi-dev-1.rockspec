...
build = {
	...
	modules = {
		...
		-- ["xi.compare_tables"] = "src/xi/compare_tables.lua",
		-- ["xi.dump"] = "src/xi/dump.lua",
		["xi.fraction"] = "src/xi/fraction.lua",
		-- ["xi.time_span"] = "src/xi/time_span.lua",
		...
		-- ["xi.list"] = "src/xi/list.lua",
		-- ["xi.stream_target"] = "src/xi/stream_target.lua",
		-- ["xi.stream"] = "src/xi/stream.lua",
		-- ["xi.type"] = "src/xi/type.lua",
