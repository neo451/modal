...
do
  ...
  stack, slow, pure, fastcat, _patternify, _patternify_p_p, _patternify_p_p_p = _obj_0.stack, _obj_0.slow, _obj_0.pure, _obj_0.fastcat, _obj_0._patternify, _obj_0._patternify_p_p, _obj_0._patternify_p_p_p
end
...
local _juxBy, juxBy, _jux, jux, _striate, striate, _chop, chop, slice, splice, _loopAt, loopAt, fit, _legato, legato
